        ...
        <section className="py-16 px-4 bg-white dark:bg-background-dark">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                    {/* Expanded FAQ Item */}
                    <div className="rounded-xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/50 dark:bg-blue-900/10 overflow-hidden">
                        <button className="flex w-full items-center justify-between text-left p-4">
                            ...
                            <span className="material-symbols-outlined text-primary dark:text-blue-300">remove</span>
                        </button>
                    ...
                    {[
                        ...
                        <div key={idx} className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 overflow-hidden">
                            <button className="flex w-full items-center justify-between text-left p-4 group">
                                <span className="text-base font-bold text-slate-800 dark:text-slate-200 group-hover:text-primary transition-colors">{question}</span>
